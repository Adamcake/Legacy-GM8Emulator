...
namespace CodeActionManager {
    ...
    bool Run(CodeAction* actions, unsigned int count, InstanceHandle self, InstanceHandle other, int ev, int sub, unsigned int asObjId);
    ...
    bool RunInstanceEvent(int ev, int sub, InstanceHandle target, InstanceHandle other, unsigned int asObjId);
